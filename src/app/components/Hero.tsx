  ...
  return (
    ...
    id="home" className="h-[100dvh] w-full flex flex-row items-center justify-center">
      <div className="flex flex-col items-center  justify-center gap-5">
        <img src="/foto_perfil.jfif"  className="rounded-full w-32 lg:w-52 shadow-lg shadow-gray-900"></img>
        ...
        <p className="w-11/12 lg:w-2/5 opacity-80">
         Me gusta utilizar diversas herramientas y tecnologías para encontrar soluciones creativas y efectivas. Esto me ha dado habilidades flexibles y la capacidad de adaptarme a diferentes situaciones y desafíos.</p>
