...
export default function ExperienceCard({ data }: PropProject) {
  return (
    <div className="flex flex-col p-1 pl-2 gap-3 bg-white border-[1px] rounded-lg border-black mt-3 max-w-[600px] shadow-gray-700 shadow-lg hover:ring-2 ease-in-out duration-200 hover:scale-105 hover:ring-yellow-100">
