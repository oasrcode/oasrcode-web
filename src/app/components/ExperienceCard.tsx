...
export default function ExperienceCard({ data }: PropProject) {
  return (
    <div className="flex flex-col p-1 pl-2 gap-3 bg-white text-black  rounded-lg  mt-3 max-w-[600px] shadow-gray-700 shadow-lg  ease-in-out duration-200 hover:scale-105 ">
