...
export default function Projects() {
  return (
    <div className="relative flex flex-col lg:flex-row lg:flex-wrap gap-7 w-full min-h-[100dvh] pt-0 lg:pt-40 mb-50 items-start justify-start lg:justify-center">
